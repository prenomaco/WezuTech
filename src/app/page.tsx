...
export default async function Home() {
  ...
  return <main id="home"><SiteMotion /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><section className="hero"><div className="hero-beam" /><Header /><div className="hero-grid"><div className="hero-title">ENGINEERING<br />THE</div><img className="hero-vehicles" src={figmaAssets.heroVehicles} alt="Electric mobility vehicles" /><div className="hero-title next">NEXT<br />MOVEMENT</div></div><p className="hero-intro">Wezu Technologies designs and develops intelligent hardware and software systems for the vehicles and mobility platforms of tomorrow — from thermal management and vehicle control to power, diagnostics and connected electronics.</p><div className="hero-ctas"><a className="button" href="#contact">Contact Us</a><a href="#about">About</a></div></section>
    ...
    <section className="testimonial section"><div className="section-beam section-beam-testimonial" /><p className="eyebrow">WHAT PEOPLE SAY</p><div className="testimonial-stage"><img className="testimonial-frame" src={figmaAssets.quoteFrame} alt="" /><button className="testimonial-arrow left" aria-label="Previous testimonial"><img src={figmaAssets.testimonialLeftArrow} alt="" /></button><blockquote>“<strong>Wezu Technologies</strong> has consistently provided innovative solutions for our automotive projects. Their ability to understand our requirements and translate them into practical designs is remarkable. We were impressed by their commitment to quality and attention to detail throughout the process.”<footer><strong>Automotive OEM Client</strong><br />Exceptional Innovation and Service</footer></blockquote><button className="testimonial-arrow right" aria-label="Next testimonial"><img src={figmaAssets.testimonialRightArrow} alt="" /></button></div><div className="dots"><b /> <i /> <i /> <i /></div></section>
