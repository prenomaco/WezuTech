...
export function AnalyticsConsent() {
  ...
  return <>
    ...
    {consent === null && <aside className="consent" role="dialog" aria-label="Analytics preference"><p>We use optional analytics to improve Wezu’s website. <a href="/privacy-policy">Privacy Policy</a></p><div><button className="text-button" onClick={() => choose("declined")}>Decline</button><button className="button" onClick={() => choose("accepted")}>Accept analytics</button></div></aside>}
  </>;
}
