...
import { INDUSTRY_IMAGE_HEIGHT, industries, type Industry } from "@/content/site-content";

/**
 * The markets Wezu builds for, as the home page's own section.
 *
 * This is not the product taxonomy — the catalogue is filed under product
 * families which live in the database and are managed in the dashboard. This
 * section answers the other question, who the work is for, and every length
 * below is the Figma frame's so it can be checked against the file. Each cell
 * links to the catalogue, which is what a reader who recognises their own
 * industry here wants next.
 */
 ...
 */
const COLUMN = [
  { gap: "gap-[0.8125rem] lg:gap-[1rem]", body: "max-w-[16.1875rem] lg:max-w-[82.53%]" },
  { gap: "gap-[0.8125rem] lg:gap-[0.3125rem]", body: "max-w-[16.1875rem] lg:max-w-[91.32%]" },
  { gap: "gap-[0.8125rem] lg:gap-[0.6875rem]", body: "max-w-[16.1875rem] lg:max-w-[89.59%]" },
] as const;
