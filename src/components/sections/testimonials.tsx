 ...
 */
export function Testimonials({ testimonials }: { readonly testimonials: readonly PublicTestimonial[] }) {
  ...
  return (
    <Section className="pt-[1.4375rem] lg:pt-[4.5625rem] lg:pb-[3.125rem]">
      <SectionHeading
